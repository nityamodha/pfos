        ...
        <div className="flex items-start justify-between gap-2">
          ...
          {lowPoint ? (
            <div className="text-right">
              ...
              <p className={cn("text-sm font-semibold tabular-nums", negative && "text-red-400")}>
            ...
            <AreaChart data={points} margin={{ top: 4, right: 4, left: 4, bottom: 0 }}>
              <defs>
                <linearGradient id="fill-forecast" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor={negative ? "#f87171" : "#34d399"} stopOpacity={0.4} />
                  <stop offset="100%" stopColor={negative ? "#f87171" : "#34d399"} stopOpacity={0.02} />
                </linearGradient>
              </defs>
              <XAxis
                dataKey="label"
            ...
            {simCard && simAmount > 0 ? (
              simCard.settlesToTarget ? (
                <p className="text-xs text-muted-foreground">
                  ...
                  {negative ? (
                    <span className="text-red-400"> · dips you below ₹0</span>
                  ) : (
